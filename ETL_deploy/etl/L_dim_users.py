...
def insert_data(df, conn):
    ...
    insert = """insert into public.dim_users 
        (company_id, user_db_id, name, last_name, email, position, contract_profile, area, sub_area,
        country, created_at, updated_at, valid_from, valid_to, is_current)
